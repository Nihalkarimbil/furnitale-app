...
function AdLiving() {
    const { Living } = useContext(admincontext);
    return (
        <div className='w-full mr-28 '>
            
            <div className="shadow-md mt-20 sm:rounded-lg md:rounded-lg ml-14  ">
            <h3 className='text-center font-bold text-xl py-2'>Living Room</h3>
